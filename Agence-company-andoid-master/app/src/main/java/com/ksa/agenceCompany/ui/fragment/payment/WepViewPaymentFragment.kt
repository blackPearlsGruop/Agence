...
import com.ksa.agenceCompany.databinding.FragmentWepViewPaymentBinding
import com.ksa.agenceCompany.ui.activity.MainActivity

import org.koin.androidx.viewmodel.ext.android.viewModel


class WepViewPaymentFragment : BaseFragment<FragmentWepViewPaymentBinding>() {

    override fun getLayoutId(): Int = R.layout.fragment_wep_view_payment
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (arguments != null) {
            val args: WepViewPaymentFragmentArgs =
                WepViewPaymentFragmentArgs.fromBundle(requireArguments())
            url = args.urlPay
