...
class SettingsViewController: UIViewController, NavigationDelegateProtocollogout, NavigationDelegateProtocolremove {
    ...
    override func viewDidLoad() {
        ...
        settingsArr = ["Profile".localized(),"Services".localized(),"Add Works".localized(),"Language".localized(),"Price per hour for consultation".localized(),"Contact Us".localized(),"Terms And Conditions".localized(),"Remove Account".localized(),"Log Out".localized()]
        settingsArrImages = [   "profile","orders","works","lang","hour","contact","terms","logout","logout"]
...
extension SettingsViewController:UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case 1: // Services
            print("Services")
            let storyboard =  UIStoryboard(name:"Settings", bundle: nil)
            let userlogin = storyboard.instantiateViewController(withIdentifier:"ServicesViewController") as! ServicesViewController
            self.navigationController?.pushViewController(userlogin, animated: true)
             ...
             case 2: // Add Works
                 print("Add Works")
                 let storyboard =  UIStoryboard(name:"Settings", bundle: nil)
                 let userlogin = storyboard.instantiateViewController(withIdentifier:"AddWorksViewController") as! AddWorksViewController
                 self.navigationController?.pushViewController(userlogin, animated: true)
        case 3:// Language
        ...
        case 4: // Price per hour for consultation
            print("Price per hour for consultation")
            let storyboard =  UIStoryboard(name:"Settings", bundle: nil)
            let userlogin = storyboard.instantiateViewController(withIdentifier:"ConsultationHourViewController") as! ConsultationHourViewController
            self.navigationController?.pushViewController(userlogin, animated: true)
