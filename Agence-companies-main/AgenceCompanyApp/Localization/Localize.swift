...
func getServerLang () -> String{
    ...
    if(Localize.currentLanguage().contains("en") == true){
       return "en"
    }else
    {
         return "ar"
...
open class Localize: NSObject {
    static var current_Language : String {
        get {
            guard let current_Language  = UserDefaults.standard.value(forKey: "current_Language") as? String ,current_Language == "ar" else {
                return "en"
            }
