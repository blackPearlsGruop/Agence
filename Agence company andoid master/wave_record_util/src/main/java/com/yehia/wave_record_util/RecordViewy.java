 ...
 */
public class RecordViewy extends RelativeLayout {
    ...
    private RecordButtonY recordButton;
    ...
    public RecordViewy(Context context) {
        super(context);
    ...
    public RecordViewy(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        init(context, attrs, -1, -1);
    }

    public RecordViewy(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        View view = View.inflate(context, R.layout.record_view_layout2, null);
        addView(view);
    ...
    protected void onActionDown(RecordButtonY recordBtn, MotionEvent motionEvent) {
    ...
    protected void onActionMove(RecordButtonY recordBtn, MotionEvent motionEvent) {
        if (!canRecord) {
            return;
        }
    ...
    protected void onActionUp(RecordButtonY recordBtn) {
        boolean audio = EX.checkPermission(Manifest.permission.RECORD_AUDIO, getContext());
        boolean readStorage = EX.checkPermission(Manifest.permission.READ_EXTERNAL_STORAGE, getContext());
        boolean writeStorage = EX.checkPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE, getContext());
    ...
    private void resetRecord(RecordButtonY recordBtn) {
